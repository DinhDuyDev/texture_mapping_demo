...
quick_access_texture = [
    (brick_texture, brick_texture_subsurfaces),
    (fun_texture, fun_texture_subsurfaces),
    (stone_texture, stone_texture_subsurfaces),
    (dirty_brick_texture, dirty_brick_texture_subsurfaces),
]
pygame.display.quit()